...
local function readDoubleBE(address, numberOfBytesToRead)
	return intToDouble(readIntBE(address, numberOfBytesToRead))
end

local function readDoubleLE(address, numberOfBytesToRead)
	return intToDouble(readIntLE(address, numberOfBytesToRead))
end
